...
const About = () => {
    ...
    return (
        <div className=' my-40'>
           <p className='text-4xl text-center mb-10'>My <span className='text'>Specializations</span> </p>


            <div className='grid md:grid-cols-2  gap-5 md:mx-20 mx-5'>

                <div  data-aos="fade-right" data-aos-offset="200" data-aos-duration="1000"  className='md:flex justify-center gap-5 border-2 rounded-2xl p-5 bg-white bg-opacity-10'>
                    <div>
                ...
                <div  data-aos="fade-left" data-aos-offset="200" data-aos-duration="1000"  className='md:flex justify-center gap-5 border-2 rounded-2xl p-5 bg-white bg-opacity-10'>
                    <div>
